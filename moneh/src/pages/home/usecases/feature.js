                    ...
                    <div id="carouselExampleSlidesOnly" className="carousel slide mt-4" data-bs-ride="carousel">
                        <div className="carousel-inner">
                            <div class="carousel-item active">
                                <img src="http://localhost:3000/assets/stats.png" style={{maxWidth:"50%", minWidth:"300px"}} className="img img-fluid mb-3"/>
                                <h4 className="text-white">View statistic of your income and outcome</h4>
                            </div>
                            <div className="carousel-item">
                                <img src="http://localhost:3000/assets/pocket.png" style={{maxWidth:"50%", minWidth:"300px"}} className="img img-fluid mb-3"/>
                            ...
                            <div className="carousel-item">
                                <img src="http://localhost:3000/assets/dashboard.png" style={{maxWidth:"50%", minWidth:"300px"}} className="img img-fluid mb-3"/>
